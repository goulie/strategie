                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="mode_paiement" name="mode_paiement" class="form-control" required>
                                            ...
                                            <option value="orange_money"
                                                {{ old('mode_paiement', $dataTypeContent->mode_paiement ?? '') == 'orange_money' ? 'selected' : '' }}>
                                                Orange Money
                                            </option>

                                            <option value="mtn_momo"
                                                {{ old('mode_paiement', $dataTypeContent->mode_paiement ?? '') == 'mtn_momo' ? 'selected' : '' }}>
                                                MTN Mobile Money - MoMo
                                            </option>

                                            <option value="wave_money"
                                                {{ old('mode_paiement', $dataTypeContent->mode_paiement ?? '') == 'wave_money' ? 'selected' : '' }}>
                                                Wave Money
                                            </option>

                                            <option value="moov_flooz"
                                                {{ old('mode_paiement', $dataTypeContent->mode_paiement ?? '') == 'moov_flooz' ? 'selected' : '' }}>
                                                Moov Money - Flooz
                                            </option>
                                        </select>
                                    </div>
