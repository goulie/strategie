    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row">
                    @php
                        $services = App\Models\RhService::withCount('rhListes')->get();
                    @endphp
...
@section('javascript')
    ...
    <script>
        Highcharts.chart('container-service', {
            chart: {
                type: 'column'
            },
        
            title: {
                text: 'Effectif du personnel par service'
            },
            ...
            xAxis: {
                categories: [
                    @foreach ($services as $service)
                        @json($service->libelle_service)@if (!$loop->last),@endif
                    @endforeach
                ],
                crosshair: true,
                title: {
            ...
            tooltip: {
                ...
                pointFormat: 'Effectif : <b>{point.y}</b>'
            },
            ...
            series: [{
                ...
                data: [
                    @foreach ($services as $service)
                        {{ $service->rh_listes_count }}@if (!$loop->last),@endif
                    @endforeach
                ]
            }]
        });
