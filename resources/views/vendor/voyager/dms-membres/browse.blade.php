        ...
        {{-- <div class="row">
            <div class="main-container">
                ...
                <div class="header-title">
                    ...
                    <p class="text-muted">Téléchargez le modèle à gauche et importez votre fichier complété à droite.</p>
                </div>
                    ...
                    <div class="col-md-6 vertical-divider">
                        <div class="template-section">
                            <div class="template-info">
                                <span class="glyphicon glyphicon-file template-icon"></span>
                                <strong style="font-size: 18px; display: block; color: #2c3e50;">Modèle de
                                    structure</strong>
                                <p class="text-muted">Utilisez ce fichier pour garantir la compatibilité des données.</p>
                            </div>
                            <a href="#" class="btn btn-success btn-lg">
                                <span class="glyphicon glyphicon-download-alt"></span> Télécharger le Template
                            </a>
                        </div>
                    </div>
                        ...
                        <form id="excel-form">
                            <div class="upload-zone" id="drop-area">
                                ...
                                <span class="glyphicon glyphicon-cloud-upload"
                                    style="font-size: 40px; color: #3498db;"></span>
                                <p id="instruction-text" style="margin-top: 10px;">
                                    Glissez votre fichier ici ou <strong>cliquez</strong> pour parcourir
                                </p>
                                <div id="file-name-display"></div>
                            </div>

                            <button type="submit" class="btn btn-block btn-upload btn-lg">
            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('export.membres.all') }}" method="GET">
                                    @csrf
                                    <button type="submit" class="btn btn-info">
                                        <i class="bi bi-file-earmark-spreadsheet-fill"></i> Exporter tous les membres
                                    </button>
                                </form>
                            </div>
                        </div>
