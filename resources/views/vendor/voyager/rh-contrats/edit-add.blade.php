...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ $edit ? 'Modifier un contrat' : 'Ajouter un contrat' }}
    </h1>
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-4" id="collaborateur_id">
                                <label for="collaborateur_id">Matricule collaborateur</label>
                                <select class="form-control select3" id="collaborateur_id" name="collaborateur_id" required @php if ($edit) echo 'disabled'; @endphp>
                                    <option value="">-- Sélectionner un collaborateur --</option>
                                    @foreach ($collaborateurs as $collaborateur)
                                        <option value="{{ $collaborateur->id }}"
                                            {{ old('collaborateur_id', $dataTypeContent->personel_id ?? '') == $collaborateur->id ? 'selected' : '' }}>
                                            {{ $collaborateur->Nom }} {{ $collaborateur->Prenoms }} <strong> -
                                                {{ $collaborateur->Matricule }}</strong>
                                        </option>
                                    @endforeach
                                </select>
                            </div>
